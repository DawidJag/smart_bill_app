...
def save_report(settlement_name, payments):
    ...
    for person in payments.keys():
        transfers = payments[person]
        data = [['Payer:', person], ['Receivers:', '']]
        ...
        t = Table(data)
        t.setStyle(TableStyle([('BACKGROUND', (0, 0), (-1, 0), colors.deepskyblue),
                               ('TEXTCOLOR', (0, 0), (-1,0), colors.white),
                               ('BACKGROUND', (0, 1), (0,-1), colors.lightslategray)]))
        elements.append(t)
